/**
 * MimoCode provider presets — standalone list for MimoCode
 */
import type { PresetTheme, TemplateValueConfig } from "./claudeProviderPresets";
import type { MimoCodeProviderConfig } from "@/types";
...
export const mimocodeProviderPresets: MimoCodeProviderPreset[] = [
  ...
  },
  {
    ...
    iconColor: "#6566F1",
    templateValues: {
      apiKey: { label: "API Key", placeholder: "sk-or-...", editorValue: "" },
    },
  },
  {
    name: "TheRouter",
  ...
  },
  {
    ...
    icon: "pipellm",
    templateValues: {
      apiKey: { label: "API Key", placeholder: "pipe-...", editorValue: "" },
    },
  },
  {
    name: "AiHubMix",
  ...
  // ==================== Cloud Provider ====================
  {
    ...
    settingsConfig: {
      ...
      models: {
        ...
        "global.anthropic.claude-sonnet-5": { name: "Claude Sonnet 5" },
